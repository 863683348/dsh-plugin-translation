...
function apply(ctx, config) {
  ...
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      pairs: { type: "array", items: { type: "object", additionalProperties: false }, description: "Segment pairs [{source, target}] (consistency)." },
      glossary: { type: "array", items: { type: "object", additionalProperties: false }, description: "Glossary terms [{source, target}] (consistency)." },
      notes: { type: "string", description: "Tone notes to save, e.g. keep contractions out (tone_save)." },
      glossaryTerms: { type: "array", items: { type: "object", additionalProperties: false }, description: "Glossary terms [{source, target}] to enforce (quality)." },
    },
    output: {
      schema: {
        type: "object",
